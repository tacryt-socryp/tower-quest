...
struct  X509Store_t378  : public Object_t
{
	...
	X509Certificate2Collection_t369 * ___list_2;
	...
	X509Store_t392 * ___store_4;
};
struct X509Store_t378_StaticFields{
	...
	Dictionary_2_t124 * ___U3CU3Ef__switchU24mapF_5;
};
