...
struct  X509EnhancedKeyUsageExtension_t875  : public X509Extension_t861
{
	...
	OidCollection_t872 * ____enhKeyUsage_4;
...
struct X509EnhancedKeyUsageExtension_t875_StaticFields{
	...
	Dictionary_2_t9 * ___U3CU3Ef__switchU24mapE_6;
};
