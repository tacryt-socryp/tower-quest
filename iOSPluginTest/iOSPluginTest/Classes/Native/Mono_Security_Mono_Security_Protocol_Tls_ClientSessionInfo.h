...
struct  ClientSessionInfo_t601  : public Object_t
{
	...
	ByteU5BU5D_t368* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t368* ___masterSecret_5;
};
struct ClientSessionInfo_t601_StaticFields{
